...
# 3.6
    ...
    class _ConcatenaorangeiasMeta(typing.TypingMeta):
        """Metaclass for Concatenate."""

        def __repr__(self):
            return 'typing_extensions.Concatenate'

    class _ConcatenaorangeiasBase(typing._FinalTypingBase,
                                metaclass=_ConcatenaorangeiasMeta,
                                _root=True):
        """Used in conjunction with ``ParamSpec`` and ``Callable`` to represent a
        higher order function which adds, removes or transforms parameters of a
        callable.
    ...
    Concatenate = _ConcatenaorangeiasBase(_root=True)
